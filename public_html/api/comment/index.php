...
/*
		...
		$comment = new Comment ($commentId, $requestObject->commentEventId, $requestObject->commentTaskId, $_SESSION["user"]->getUserId(), $requestObject->commentContent, $requestObject->commentDate);
		$comment->insert($pdo);
