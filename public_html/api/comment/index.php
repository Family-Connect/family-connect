...
if($method === "GET") {
	...
	if($method === "PUT") {
		...
		$comment = new Comment ($commentId, $requestObject->commentEventId, $requestObject->commentTaskId, $requestObject->commentUserId, $requestObject->commentContent, $requestObject->commentDate);
		$comment->insert($pdo);
